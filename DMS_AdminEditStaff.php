...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="container" id="container_addstaffpage">
            ...
            <form action="toUpdateStaff.php" method="post" enctype="multipart/form-data">
    
                <div class="details" id="staffdetails">

                    <center><h3> Edit Staff </h3></center>
    
                    <div class="fields">
                        
                        <div class="input-field">
                            <center><br><label> Staff ID: </label><br>
                            <input type="text" name = "staff_id" placeholder="Staff ID"  value="<?php echo $staff_id; ?>"> </center>
                        </div>  

                        <div class="input-field">
                            <center><br><label> Staff Password: </label><br>
                            <input type="text" name = "staff_password" placeholder="Staff Password"  value="<?php echo $staff_password; ?>"> </center>
                        </div> 

                        <div class="input-field">
                            <center><br><label> First Name: </label><br>
                            <input type="text" name = "staff_firstname" placeholder="First Name"  value="<?php echo $staff_firstname; ?>"> </center>
                        </div>

                        <div class="input-field">
                            <center><br><label> Last Name: </label><br>
                            <input type="text" name = "staff_lastname" placeholder="Last Name"  value="<?php echo $staff_lastname; ?>">
                            </center>
                        </div>

                        <center><br>
                            <button type="submit" class="submit" value="update" name="update_staff"> Update </button>
                        </center>
